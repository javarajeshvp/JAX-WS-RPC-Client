 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://jaxwsrpc.soap.webservice.vp.com/", wsdlLocation = "http://10.227.215.81:999/ws/soap/jaxwsrpc/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://jaxwsrpc.soap.webservice.vp.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.227.215.81:999/ws/soap/jaxwsrpc/hello?wsdl");
    ...
    public IHelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://jaxwsrpc.soap.webservice.vp.com/", "HelloWorldImplPort"), IHelloWorld.class);
    }
    ...
    public IHelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxwsrpc.soap.webservice.vp.com/", "HelloWorldImplPort"), IHelloWorld.class, features);
    }
